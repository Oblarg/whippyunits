//! Shared dimension data for whippyunits
//! 
...
pub const DIMENSION_LOOKUP: &[DimensionInfo] = &[
    ...
    DimensionInfo {
        ...
        name: "Mass",
        si_symbol: Some("kg"),
        si_long_name: Some("kilogram"),
    },
    DimensionInfo {
        exponents: (0, 1, 0, 0, 0, 0, 0, 0),
        name: "Length",
        si_symbol: Some("m"),
        si_long_name: Some("meter"),
    },
    DimensionInfo {
        exponents: (0, 0, 1, 0, 0, 0, 0, 0),
        name: "Time",
        si_symbol: Some("s"),
        si_long_name: Some("second"),
    },
    DimensionInfo {
        exponents: (0, 0, 0, 1, 0, 0, 0, 0),
        name: "Current",
        si_symbol: Some("A"),
        si_long_name: Some("ampere"),
    },
    DimensionInfo {
        exponents: (0, 0, 0, 0, 1, 0, 0, 0),
        name: "Temperature",
        si_symbol: Some("K"),
        si_long_name: Some("kelvin"),
    },
    DimensionInfo {
        exponents: (0, 0, 0, 0, 0, 1, 0, 0),
        name: "Amount",
        si_symbol: Some("mol"),
        si_long_name: Some("mole"),
    },
    DimensionInfo {
        exponents: (0, 0, 0, 0, 0, 0, 1, 0),
        name: "Luminosity",
        si_symbol: Some("cd"),
        si_long_name: Some("candela"),
    },
    DimensionInfo {
        exponents: (0, 0, 0, 0, 0, 0, 0, 1),
        name: "Angle",
        si_symbol: Some("rad"),
        si_long_name: Some("radian"),
    },
...
pub fn lookup_dimension_by_name(name: &str) -> Option<&DimensionInfo> {
...
pub fn lookup_dimension_by_exponents(exponents: DimensionExponents) -> Option<&DimensionInfo> {
